...
<form class="form-horizontal" role="form">
    <div class="form-group">
        <label for="create-taskOwner" class="col-sm-2 control-label">所有者<span
    ...
    <div class="form-group">
        ...
        <label for="create-contacts" class="col-sm-2 control-label">联系人&nbsp;&nbsp;<a href="javascript:void(0);"
                                                                                      data-toggle="modal"
    ...
    <div id="reminderTimeDiv"
         style="width: 500px; height: 180px; background-color: #EEEEEE; position: relative; left: 185px; top: 20px; display: none;">
